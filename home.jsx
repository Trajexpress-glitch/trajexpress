        ...
        <section className="section">
          <div className="card" style={{ display: "grid", gridTemplateColumns: "1.4fr 1fr", gap: 32, alignItems: "center", padding: 40, background: "linear-gradient(135deg, white 0%, var(--blue-tint) 100%)" }}>
            ...
            <div style={{ display: "grid", gap: 10 }}>
              <div className="card" style={{ background: "white", padding: 18, borderRadius: 14 }}>
                <div className="muted small" style={{ marginBottom: 6 }}>Exemple : trajet Québec → Montréal</div>
                <div className="row-between">
                  <div>
                    <div className="small muted">3 sièges à 28 $</div>
                    <div style={{ fontFamily: "var(--font-serif)", fontSize: 28, color: "var(--blue-deep)", lineHeight: 1.1, marginTop: 2 }}>84 $</div>
                  </div>
                  <div style={{ textAlign: "right" }}>
                    <div className="small muted">Frais TJX</div>
                    <div style={{ fontFamily: "var(--font-serif)", fontSize: 22, color: "var(--red-deep)", marginTop: 2 }}>− 6 $</div>
                  </div>
                  <div style={{ textAlign: "right" }}>
                    <div className="small muted">Net</div>
                    <div style={{ fontFamily: "var(--font-serif)", fontSize: 28, color: "var(--blue-deep)", lineHeight: 1.1, marginTop: 2, fontWeight: 600 }}>78 $</div>
                  </div>
                </div>
              </div>
